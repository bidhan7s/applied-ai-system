...
class SongNoteStore:
    ...
    def __init__(self, notes_path: str):
        self.notes: Dict[int, str] = self._parse_notes(notes_path)
    ...
    @staticmethod
    def _parse_notes(notes_path: str) -> Dict[int, str]:
        ...
        for i, match in enumerate(matches):
            ...
            notes[song_id] = content[start:end].strip()
        return notes
